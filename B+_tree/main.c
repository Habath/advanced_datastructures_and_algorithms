...
int main(int argc, char ** argv) {
    printf("\nkindly place the input file in same directory or provide the exact location of the file in fopen statement\n");
	char * input_file;
	FILE * fp;
	node * root;
